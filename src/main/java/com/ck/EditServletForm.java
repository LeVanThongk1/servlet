...
public class EditServletForm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<form action='EditServlet' methor= 'post'>");
		out.print("<table>");
		out.print("<tr><td><input type='hidden' name='id' value='" + e.getId()+"'/></td></tr");
		out.print("<tr><td>Name:</td><td><input type='text' name='name' value='" + e.getId()+"'/></td></tr>");
		out.print("<tr><td>Select Subject:</tr></td>");
